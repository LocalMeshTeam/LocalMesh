...
import { decodePacket, encodePacket, helloSigningData, messageSigningData, PROTOCOL_VERSION, type HelloPacket, type MessagePacket, type NetworkPacket } from "./protocol.js";
...
export class NetworkTransport {
  ...
  private handlePacket(socket: Socket, packet: NetworkPacket): void {
    ...
    if (!peer || packet.sender_id !== peer.device_id || packet.receiver_id !== this.identity.device_id) return;
